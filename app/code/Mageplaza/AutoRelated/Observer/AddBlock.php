...
class AddBlock implements ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        if ($fullActionName == 'catalog_product_view' || $fullActionName == 'catalog_category_view' || $fullActionName == 'checkout_cart_index' | $fullActionName == 'onestepcheckout_index_index') {
            $types = [
                'content' => 'content',
